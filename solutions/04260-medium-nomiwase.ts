...
type Ta = AllCombinations<"">;
type Tb = AllCombinations<"A">;
type Tc = AllCombinations<"AB">;
type Td = AllCombinations<"ABC">;

type CombineUnion<T extends string, Clone extends string = T> = T extends ""
  ? ""
  : `${T}${CombineUnion<Clone extends T ? "" : Clone>}`;

type TTT = CombineUnion<"" | "A" | "B" | "C">;
